...
function fixFile(filePath) {
    ...
    content = content.replace(/const features = await this\.analyzeWithEssentia\(;\s*file_path,/gm, 
    ...
    content = content.replace(/path\.join\(__dirname, 'src', `audio-analyzer`\);/g, 
    ...
    content = content.replace(/const analyzerBinary = bmp && decodedKey\s*\?\s*path\.join/gm, 
