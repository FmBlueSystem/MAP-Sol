...
class SmartPlaylistWizard {
    ...
    renderPreview(tracks) {
        ...
        document.getElementById('total-duration').textContent = hours > 0 ? `${hours}h ${displayMins}m` : `${mins}m`;
        ...
        tracks.slice(0, 10).forEach((track, index) => {
            html += `
                <div class="preview-track">
                    ...
                    <img src="${track.artwork_url || 'assets/images/default-album.png'}" alt="" class="track-thumb">
