...
const tasks = [
    ...
    },
    {
        ...
        description:
            '5-star rating, favoritos con corazón, persistencia DB, filtros. Ref: ROADMAP.md líneas 538-556',
        status: 'todo',
        task_order: 5,
        feature: 'Feature'
    },
    ...
    },
    {
        ...
        description:
            'Split main.js en módulos lógicos. Meta: main.js <100 líneas. Ref: ROADMAP.md líneas 195-244',
        status: 'todo',
        task_order: 6,
        feature: 'Technical Debt'
    },
