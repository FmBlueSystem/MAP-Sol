...
class KeyboardShortcuts {
    ...
    clearAll() {
        ...
        if (window.updateRangeDisplays) window.updateRangeDisplays();
    ...
    filterHighEnergy() {
        ...
        document.getElementById('energyMax').value = 100;
        if (window.updateEnergyRange) window.updateEnergyRange();
        if (window.performSearch) window.performSearch();
    }
    ...
    filterFastBPM() {
        ...
        document.getElementById('bpmMax').value = 200;
        if (window.updateBPMRange) window.updateBPMRange();
        if (window.performSearch) window.performSearch();
    }
