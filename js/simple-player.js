...
class SimplePlayer {
        ...
        const playerHTML = `
            <div id="simple-player-bar" class="simple-player-bar">
                ...
                <div class="player-track-info">
                    ...
                    <div class="track-details">
                        ...
                        <div class="player-meta">
                            ...
                            <span class="separator">•</span>
                            <span id="player-energy" class="player-energy">--</span>
                            <span class="separator">•</span>
                            <span id="player-mood" class="player-mood">--</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="player-vu-section">
                    <div class="vu-meter-label">Audio Levels</div>
                    <canvas id="vu-meter-canvas" width="500" height="50"></canvas>
                    <div class="spectrum-visualizer" id="spectrum-bars">
    ...
    updateTrackInfo(track) {
        ...
        document.getElementById('player-bpm').textContent =
            (track.bpm || track.AI_BPM || track.existing_bpm || '--') + ' BPM';
        document.getElementById('player-key').textContent = track.key || track.AI_KEY || track.existing_key || '--';

        // Update energy (if exists, show as percentage)
        const energy = track.energy || track.AI_ENERGY;
        document.getElementById('player-energy').textContent = energy ? `${Math.round(energy * 100)}% Energy` : '--';

        // Update mood
        document.getElementById('player-mood').textContent = track.mood || track.AI_MOOD || '--';
