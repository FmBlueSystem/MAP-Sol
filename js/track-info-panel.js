...
class TrackInfoPanel {
    constructor() {
        ...
        this.isExpanded = false; // Start collapsed to save screen space
        this.panel = null;
        this.init();
    }
...
// DISABLED: Track Info Panel to save screen space
// Uncomment the following lines to re-enable the Track Analysis panel
/*
