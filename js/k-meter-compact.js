...
class KMeterCompact {
    ...
    updateDisplay(peaks) {
        ...
        const leftHold =
            document.getElementById('peak-left-hold-bar') ||
            document.getElementById('peak-left-hold');
        ...
        const rightHold =
            document.getElementById('peak-right-hold-bar') ||
            document.getElementById('peak-right-hold');
