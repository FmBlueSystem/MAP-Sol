...
class KMeterCompact {
    ...
    connectAudio() {
        if (this.isConnected || !this.audioElement) return;
    ...
    calculatePeak() {
        if (!this.analyser) return { left: -Infinity, right: -Infinity };
    ...
    updateDisplay(peaks) {
        ...
        const leftFill = document.getElementById('vu-left') || document.getElementById('peak-left-fill-bar') || document.getElementById('peak-left-fill');
        const leftValue = document.getElementById('vu-val-l') || document.getElementById('peak-left-value-bar') || document.getElementById('peak-left-value');
        ...
        const rightFill = document.getElementById('vu-right') || document.getElementById('peak-right-fill-bar') || document.getElementById('peak-right-fill');
        const rightValue = document.getElementById('vu-val-r') || document.getElementById('peak-right-value-bar') || document.getElementById('peak-right-value');
