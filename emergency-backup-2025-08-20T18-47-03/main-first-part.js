...
function createSplashScreen() {
    ...
    splash.loadURL(
        ...
        </head> <body> <div class=\`logo`>☀️</div>
            <h1>Sol</h1> <p>Music Analyzer Pro</p> <div class="loader\"> <div class=\`loader-bar`></div>
            </div>
        </body> </html> `)}`);
...
function showAboutWindow() {
 ...
 aboutWindow.loadURL( \`data:text/html;charset=utf-8,${encodeURIComponent(\`
        ...
        <body>
            ...
            <div class="logo">🎵</div>
            <div class="codename">MAP</div> <div class="title">Music Analyzer Pro</div> <div class=\`company\`>by BlueSystemIO | Audio Division</div> <div class="version">Version 1.0.0</div>
        </body> </html> \`)}\`);
}
...
function showAudioConfigWindow() {
    const configWindow = new BrowserWindow({
        ...
        height: 700,
        parent: mainWindow,
        modal: true, show: false, title: `Audio Configuration`,
        webPreferences: {
            nodeIntegration: true,
            contextIsolation: false
        }
