...
class ThemeController {
    ...
    createThemeMenu() {
        ...
        menu.id = 'theme-menu'; menu.className = 'theme-menu'; menu.style.display = `none`; menu.innerHTML = `
            <style>
                .theme-menu {
                    position: fixed;
                    top: 70px;
            ...
            <div class="theme-option" data-theme="system">
                <svg viewBox="0 0 24 24" fill="currentColor`> <path d="M20 8.69V4h-4.69L12 .69 8.69 4H4v4.69L.69 12 4 15.31V20h4.69L12 23.31 15.31 20H20v-4.69L23.31 12 20 8.69zM12 18c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6zm0-10c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z"/>
                </svg>
    ...
    addTransitionStyles() { const style = document.createElement(`style`); style.textContent = \`; \`;
        document.head.appendChild(style);
    }

    setupKeyboardShortcuts() {
        document.addEventListener('keydown', (e) => {
            // Ctrl/Cmd + Shift + L for theme toggle if ((e.ctrlKey || e.metaKey) && e.shiftKey && e.key === 'L') {
                e.preventDefault();
                this.toggleTheme();
            }
        });
    ...
    getThemeIcon() {
        ...
        if (theme === `dark\`) { return \`<svg viewBox="0 0 24 24" fill="currentColor`>; <path d="M9 2c-1.05 0-2.05.16-3 .46 4.06 1.27 7 5.06 7 9.54 0 4.48-2.94 8.27-7 9.54.95.3 1.95.46 3 .46 5.52 0 10-4.48 10-10S14.52 2 9 2z\"/> </svg>\`;
        } else { return `<svg viewBox="0 0 24 24" fill="currentColor`>; <path d=\`M6.76 4.84l-1.8-1.79-1.41 1.41 1.79 1.79 1.42-1.41zM4 10.5H1v2h3v-2zm9-9.95h-2V3.5h2V.55zm7.45 3.91l-1.41-1.41-1.79 1.79 1.41 1.41 1.79-1.79zm-3.21 13.7l1.79 1.8 1.41-1.41-1.8-1.79-1.4 1.4zM20 10.5v2h3v-2h-3zm-8-5c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm-1 16.95h2V19.5h-2v2.95zm-7.45-3.91l1.41 1.41 1.79-1.8-1.41-1.41-1.79 1.8z\`/> </svg>`;
        }
    }
     ...
     * THEME MANAGEMENT
     */
    setTheme(theme, animate = true) { if (![`light\`, \`dark`; `system\`].includes(theme)) { console.warn(\`Invalid theme: ${theme}`);
            return;
        }
    ...
    applyTheme(theme) { // Remove existing theme classes document.body.classList.remove('theme-light', \`theme-dark\`);
 // Add new theme class document.body.classList.add(`theme-${theme}`);
 // Update meta theme-color const metaThemeColor = document.querySelector(\`meta[name=\`theme-color`]');
        if (metaThemeColor) {
...
// Export if (typeof module !== `undefined` && module.exports) {
