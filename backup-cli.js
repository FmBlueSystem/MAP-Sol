        ...
        switch (command) {
            ...
            case 'statistics':
                ...
                if (stats.latestBackup) {
                    console.log(`${colors.blue}Latest backup:${colors.reset} ${new Date(stats.latestBackup).toLocaleString()}`);
                }
                if (stats.oldestBackup) {
                    console.log(`${colors.blue}Oldest backup:${colors.reset} ${new Date(stats.oldestBackup).toLocaleString()}`);
                }
                break;
