    ...
    <body>
        ...
        <div class="annotations">
            <table class="annotation_table tex2jax_ignore">
                {%- for num, line in func_data[func_key]['python_lines'] -%} {%- if
                func_data[func_key]['ir_lines'][num] %}
                <tr>
                    <td class="{{func_data[func_key]['python_tags'][num]}}">
                        <details>
                            <summary>
                                <code>
                ...
                <tr>
                    <td
                        ...
                        class="{{func_data[func_key]['python_tags'][num]}}"
                    >
                        <code>
                            {{num}}: {{func_data[func_key]['python_indent'][num]}}{{line|e}}
                        </code>
